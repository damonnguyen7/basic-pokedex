(function() {
  ...
  .controller('ListController', function($scope, ListService, $state, $location) {
    //ng-repeat pokemon li
    $scope.pokemonList = ListService.pokemonList;
